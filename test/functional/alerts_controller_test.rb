...
class AlertsControllerTest < ActionController::TestCase
  ...
  test "should create alert" do
    assert_difference('Alert.count') do
      post :create, alert: { action_type: @alert.action_type, data: @alert.data, threshold: @alert.threshold }
    end
  ...
  test "should update alert" do
    put :update, id: @alert, alert: { action_type: @alert.action_type, data: @alert.data, threshold: @alert.threshold }
    assert_redirected_to alert_path(assigns(:alert))
  end
